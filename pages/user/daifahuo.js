...
Page({
  ...
  removeOrder: function(e) {
    ...
    wx.showModal({
      ...
      success: function(res) {
        ...
        res.confirm && app.util.request(app.config.OrderAction, {
            id: orderId,
            type: 'cancel',
          }, 'post')
          .then(function(res) {
  ...
  loadOrderList: function () {
    ...
    app.util.request(app.config.OrderList, {
      uid: app.data.userId,
  ...
  loadReturnOrderList: function () {
    ...
    app.util.request(app.config.LoadReturnOrderList, {
      uid: app.data.userId,
  ...
  payOrderByWechat: function (e) {
    ...
    app.util.request(app.config.Wxpay, {
      order_id: order_id,
      order_sn: order_sn,
      uid: app.data.userId
    }, 'post')
